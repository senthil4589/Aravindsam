...
import com.group.nearme.adapter.HashTagFeedAdapter;
...
public class HashTagFeedActivity extends Activity{
	...
	public HashTagFeedAdapter mAdapter;
		...
		query.findInBackground(new FindCallback<ParseObject>() {
			public void done(List<ParseObject> list, ParseException e) {
					if (e == null) 
					{
						if(list.size() > 0)
						{
							mAdapter=new HashTagFeedAdapter(HashTagFeedActivity.this,list,progressBar,mGroupId,mGroupName,mGroupImage,mGroupType);
						...
						else
						{
							...
							if(mListView.isRefreshing())
								mListView.onRefreshComplete();
							Utility.showToastMessage(HashTagFeedActivity.this, "No post available for this tag");
						}
					}
					else
						System.out.println("exception in tag feed :: "+e);
			}});
	}
