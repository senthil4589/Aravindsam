...
public class HashTagFeedAdapter extends BaseAdapter
{
	ViewHolder viewHolder;
	LayoutInflater inflater;
	HashTagFeedActivity activity;
	...
	public HashTagFeedAdapter(HashTagFeedActivity activity,List<ParseObject> list1,ProgressBar progressBar1,String id,String name,String image,String groupType)
	{
