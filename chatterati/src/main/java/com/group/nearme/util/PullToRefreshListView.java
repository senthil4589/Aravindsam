...
public class PullToRefreshListView extends ListView{
    ...
    private void init(){
        ...
        text.setTextSize(14);
        text.setTextColor(getContext().getResources().getColor(R.color.light_gray));
        lastUpdatedTextView.setTextSize(14);
        lastUpdatedTextView.setTextColor(getContext().getResources().getColor(R.color.light_gray));
